...
import static in.socialninja.cgpscguru.R.drawable.rounded_button;
...
public class quiz1 extends AppCompatActivity {
 ...
 @Override
    public void onBackPressed(){
            ...
            final AlertDialog.Builder builder = new AlertDialog.Builder(quiz1.this);
    ...
    private void UpdateQuestion() {
        ...
        if(total >20) {
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("quiz").child(String.valueOf(type)).child(String.valueOf(total));
                        ...
                        public void onClick(View v) {
                            if(b1.getText().toString().equals(question.getAnswer())){
                                ...
                                if(b2.getText().toString().equals(question.getAnswer())){
                                    b2.setBackgroundColor(Color.parseColor("#229a43"));

                                }
                                else if(b3.getText().toString().equals(question.getAnswer())) {
                                    b3.setBackgroundColor(Color.parseColor("#229a43"));
                                }
                                else if(b4.getText().toString().equals(question.getAnswer())) {
                                    b4.setBackgroundColor(Color.parseColor("#229a43"));
                                }
